  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center px-4 py-10">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center bg-white rounded-3xl shadow-2xl overflow-hidden w-full max-w-5xl">
        {/* --- Lottie Animation --- */}
        <div className="flex justify-center items-center bg-indigo-50 w-full md:w-1/2 p-6 md:p-10">
          <Lottie
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              ...
              <button
                ...
                className="flex items-center justify-center px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition duration-200 shadow-sm hover:shadow-md"
              >
